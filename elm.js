...
var $author$project$Main$anItem = function (content) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$aList = function (listContent) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$anItem, listContent));
};
var $elm$html$Html$div = _VirtualDom_node('div');
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$Main$myLaptop = {brand: 'Think', model: 'Razer', ram: '16Gb', screenSize: '14'};
